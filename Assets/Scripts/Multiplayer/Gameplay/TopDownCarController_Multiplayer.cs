...
/// </summary>
public class TopDownCarController_Multiplayer : NetworkBehaviour
{
    ...
    private NitroSystemController_Multiplayer _nitroSystemController;
    ...
    private void Awake()
    {
        ...
        _nitroSystemController = GetComponent<NitroSystemController_Multiplayer>();
    }
